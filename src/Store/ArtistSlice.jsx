...
//           const index = state.artist.findIndex(artist => artist._id === action.payload._id);
//           if (index !== -1) {
//             state.artist[index] = action.payload;
//           }
//         })
...
const artistSlice = createSlice({
    ...
    extraReducers: (builder) => {
      builder
        ...
        .addCase(fetchArtist.fulfilled, (state, action) => {
          state.loading = false;
          state.artist = action.payload.data; // Update with data array
